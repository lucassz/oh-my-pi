...
### Fixed
- Fixed hashline edit payloads that use a readability space after `~` so the separator padding is not inserted into files. ([#1166](https://github.com/can1357/oh-my-pi/issues/1166))
